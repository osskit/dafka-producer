...
if [ "$(uname -s)" == "Linux" ]; then
  BAZEL_DEPS_URL=https://github.com/bazeltools/bazel-deps/releases/download/v0.1-38/bazel-deps-linux
  BAZEL_DEPS_SHA256=273b5186b949b70369ba83c3ab85276eb1f8ac2087c0f3631e49c300e6e40d5e
elif [ "$(uname -s)" == "Darwin" ]; then
  BAZEL_DEPS_URL=https://github.com/bazeltools/bazel-deps/releases/download/v0.1-38/bazel-deps-macos
  BAZEL_DEPS_SHA256=ad38ecc1da37da32894e1b31df37da72d376c1fd1244f6f88acc2ebf4ca5fe89
else
...
BAZEL_DEPS_PATH="${BAZEL_DEPS_DIR}/v0.1-38"
